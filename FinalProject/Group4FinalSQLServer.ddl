...
( 
	...
	CONSTRAINT "CK_Template_CurrentTimeStamp_MarketingCategoryType"
		CHECK  ( MarketingCategoryType LIKE '%^[A-Za-z]%' ),
	"UserAuthorizationId" "sdInteger"."SurrogateKeyInt" ,
	"MarketingCategorySysStartTime" "sdDateTime"."DateTimeStamp" 
	CONSTRAINT "DF_Template_CurrentTimeStamp_MarketingCategorySysStartTime"
		 DEFAULT  sysdatetime(),
	"MarketingCategorySysEndTime" "sdDateTime"."DateTimeStamp" 
	CONSTRAINT "DF_Template_CurrentTimeStamp_MarketingCategorySysEndTime"
		 DEFAULT  sysdatetime(),
	"RowLevelHashKey"    "sdNumericString"."HashKey" 
)
go
...
ALTER TABLE "Audit"."Country"
	ADD CONSTRAINT "XPKCountryHistory" PRIMARY KEY  CLUSTERED ("CountryAuditId" ASC)
go
...
ALTER TABLE "Audit"."Customer"
	ADD CONSTRAINT "XPKCustomerHistory" PRIMARY KEY  CLUSTERED ("CustomerAuditId" ASC)
go
...
ALTER TABLE "Audit"."ManufacturerVehicleMake"
	ADD CONSTRAINT "XPKManufacturerMake" PRIMARY KEY  CLUSTERED ("ManufacturerMakeAuditId" ASC)
go
...
ALTER TABLE "Audit"."ManufacturerVehicleModel"
	ADD CONSTRAINT "XPKManufacturerModel" PRIMARY KEY  CLUSTERED ("ManufacturerModelAuditId" ASC)
go
...
ALTER TABLE "Audit"."ManufacturerVehicleStock"
	ADD CONSTRAINT "XPKManufacturerVehicleStockHistory" PRIMARY KEY  CLUSTERED ("ManufacturerVehicleStockAuditId" ASC)
go

ALTER TABLE "Marketing"."MarketingCategory"
	ADD CONSTRAINT "XPKMarketingCategory" PRIMARY KEY  CLUSTERED ("MarketingTypeId" ASC)
go
...
ALTER TABLE "Audit"."SalesOrderVehicle"
	ADD CONSTRAINT "XPKSalesOrderVehicleHistory" PRIMARY KEY  CLUSTERED ("SalesOrderVehicleAuditId" ASC)
go
...
ALTER TABLE "Audit"."SalesOrderVehicleDetail"
	ADD CONSTRAINT "XPKSalesOrderVehicleDetailHistory" PRIMARY KEY  CLUSTERED ("SalesOrderVehicleDetailAuditId" ASC)
go

ALTER TABLE "Marketing"."SpendCapacity"
	ADD CONSTRAINT "XPKSpendCapacity" PRIMARY KEY  CLUSTERED ("SpendCapacityID" ASC)
go
...
ALTER TABLE "Audit"."Staff"
	ADD CONSTRAINT "XPKStaffHistory" PRIMARY KEY  CLUSTERED ("StaffAuditId" ASC)
go

ALTER TABLE "dbo"."sysdiagrams"
	ADD CONSTRAINT "PK__sysdiagr__C2B05B612F18C246" PRIMARY KEY  CLUSTERED ("diagram_id" ASC)
	WITH
	(
		PAD_INDEX = OFF,
		IGNORE_DUP_KEY = OFF,
...
ALTER TABLE "Marketing"."SalesOrderVehicleDetail"
	ADD CONSTRAINT "FK_SalesOrderVehicleDetailManufacturerVehicleStock_ManufacturerVehicleStock" FOREIGN KEY ("ManufacturerVehicleStockID") REFERENCES "Inventory"."ManufacturerVehicleStock"("ManufacturerVehicleStockID")
go
