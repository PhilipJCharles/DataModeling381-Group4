...
(
	`CountryAuditId` INT COMMENT 'The COUNTRYAUDITID defines the CountryAuditId of the CountryHistory' NOT NULL ,
	`CountryId` INT COMMENT 'The COUNTRYID defines the CountryId of the CountryHistory' NOT NULL ,
...
(
	`CustomerAuditId` INT COMMENT 'The CUSTOMERAUDITID defines the CustomerAuditId of the CustomerHistory' NOT NULL ,
	`CustomerId` INT COMMENT 'The CUSTOMERID defines the CustomerId of the CustomerHistory' NOT NULL ,
...
(
	`ManufacturerMakeAuditId` INT COMMENT 'The MANUFACTURERMAKEAUDITID defines the ManufacturerMakeAuditId of the ManufacturerMake' NOT NULL ,
	`ManufacturerMakeId` INT COMMENT 'The MANUFACTURERMAKEID defines the ManufacturerMakeId of the ManufacturerMake' NOT NULL ,
...
(
	`ManufacturerModelAuditId` INT COMMENT 'The MANUFACTURERMODELAUDITID defines the ManufacturerModelAuditId of the ManufacturerModel' NOT NULL ,
	`ManufacturerVehicleModelID` INT COMMENT 'The MANUFACTURERVEHICLEMODELID defines the ManufacturerVehicleModelID of the ManufacturerModel' NOT NULL ,
...
(
	`ManufacturerVehicleStockAuditId` INT COMMENT 'The MANUFACTURERVEHICLESTOCKAUDITID defines the ManufacturerVehicleStockAuditId of the ManufacturerVehicleStockHistory' NOT NULL ,
	`ManufacturerVehicleModelId` INT COMMENT 'The MANUFACTURERVEHICLEMODELID defines the ManufacturerVehicleModelId of the ManufacturerVehicleStockHistory' NOT NULL ,
...
(
	`SalesOrderVehicleAuditId` INT COMMENT 'The SALESORDERVEHICLEAUDITID defines the SalesOrderVehicleAuditId of the SalesOrderVehicleHistory' NOT NULL ,
	`SalesOrderVehicleId` INT COMMENT 'The SALESORDERVEHICLEID defines the SalesOrderVehicleId of the SalesOrderVehicleHistory' NOT NULL ,
...
(
	`SalesOrderVehicleDetailAuditId` INT COMMENT 'The SALESORDERVEHICLEDETAILAUDITID defines the SalesOrderVehicleDetailAuditId of the SalesOrderVehicleDetailHistory' NOT NULL ,
	`SalesOrderVehicleDetailId` INT COMMENT 'The SALESORDERVEHICLEDETAILID defines the SalesOrderVehicleDetailId of the SalesOrderVehicleDetailHistory' NOT NULL ,
...
(
	`StaffAuditId` INT COMMENT 'The STAFFAUDITID defines the StaffAuditId of the StaffHistory' NOT NULL ,
	`StaffId` INT COMMENT 'The STAFFID defines the StaffId of the StaffHistory' NOT NULL ,
...
(
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the UserAuthorization' NOT NULL ,
...
(
	`DepartmentID` INT COMMENT 'The DEPARTMENTID defines the DepartmentID of the Department' NOT NULL ,
	`DepartmentName` VARCHAR(20) COMMENT 'The DEPARTMENTNAME defines the Name of the Department' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the Department' NOT NULL ,
...
(
	`StaffId` INT COMMENT 'The STAFFID defines the StaffId of the Staff' NOT NULL ,
	...
	`ManagerID` INT  DEFAULT 0 COMMENT 'The MANAGERID defines the ManagerID of the Staff' NULL ,
	`DepartmentID` INT COMMENT 'The DEPARTMENTID defines the DepartmentID of the Staff' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the Staff' NOT NULL ,
...
(
	`ManufacturerVehicleMakeID` INT COMMENT 'The MANUFACTURERVEHICLEMAKEID defines the ManufacturerVehicleMakeID of the ManufacturerVehicleMake' NOT NULL ,
	...
	`CountryId` INT COMMENT 'The COUNTRYID defines the CountryId of the ManufacturerVehicleMake' NOT NULL ,
	`MarketingTypeId` INT COMMENT 'The MARKETINGTYPEID defines the MarketingTypeId of the ManufacturerVehicleMake' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the ManufacturerVehicleMake' NOT NULL ,
...
(
	`ManufacturerVehicleModelId` INT COMMENT 'The MANUFACTURERVEHICLEMODELID defines the ManufacturerVehicleModelId of the ManufacturerVehicleModel' NOT NULL ,
	...
	`ManufacturerVehicleMakeID` INT COMMENT 'The MANUFACTURERVEHICLEMAKEID defines the ManufacturerVehicleMakeID of the ManufacturerVehicleModel' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the ManufacturerVehicleModel' NOT NULL ,
	...
	`ManufacturerVehicleModelVariantCountryID` INT COMMENT 'The MANUFACTURERVEHICLEMODELVARIANTCOUNTRYID defines the ManufacturerVehicleModelVariantCountryID of the ManufacturerVehicleModel' NOT NULL ,
...
(
	`ManufacturerVehicleStockID` INT COMMENT 'The MANUFACTURERVEHICLESTOCKID defines the ManufacturerVehicleStockID of the ManufacturerVehicleStock' NOT NULL ,
	...
	`ManufacturerVehicleModelId` INT COMMENT 'The MANUFACTURERVEHICLEMODELID defines the ManufacturerVehicleModelId of the ManufacturerVehicleStock' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the ManufacturerVehicleStock' NOT NULL ,
...
(
	`CountryId` INT COMMENT 'The COUNTRYID defines the CountryId of the Country' NOT NULL ,
	...
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the Country' NOT NULL ,
...
(
	`CustomerId` INT COMMENT 'The CUSTOMERID defines the CustomerId of the Customer' NOT NULL ,
	...
	`CountryId` INT COMMENT 'The COUNTRYID defines the CountryId of the Customer' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the Customer' NOT NULL ,
...
(
	...
	`MarketingTypeId` INT COMMENT 'The MARKETINGTYPEID defines the MarketingTypeId of the MarketingCategory' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the MarketingCategory' NOT NULL ,
...
(
	`SalesOrderVehicleId` INT COMMENT 'The SALESORDERVEHICLEID defines the SalesOrderVehicleId of the SalesOrderVehicle' NOT NULL ,
	`CustomerId` INT COMMENT 'The CUSTOMERID defines the CustomerId of the SalesOrderVehicle' NOT NULL ,
	`StaffId` INT COMMENT 'The STAFFID defines the StaffId of the SalesOrderVehicle' NOT NULL ,
	...
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the SalesOrderVehicle' NOT NULL ,
...
(
	`SalesOrderVehicleDetailId` INT COMMENT 'The SALESORDERVEHICLEDETAILID defines the SalesOrderVehicleDetailId of the SalesOrderVehicleDetail' NOT NULL ,
	`SalesOrderVehicleId` INT COMMENT 'The SALESORDERVEHICLEID defines the SalesOrderVehicleId of the SalesOrderVehicleDetail' NOT NULL ,
	...
	`ManufacturerVehicleStockID` INT COMMENT 'The MANUFACTURERVEHICLESTOCKID defines the ManufacturerVehicleStockID of the SalesOrderVehicleDetail' NOT NULL ,
	`UserAuthorizationId` INT COMMENT 'The USERAUTHORIZATIONID defines the UserAuthorizationId of the SalesOrderVehicleDetail' NOT NULL ,
...
(
	`SpendCapacityID` INT COMMENT 'The SPENDCAPACITYID defines the SpendCapacityID of the SpendCapacity' NOT NULL ,
	...
	`CustomerId` INT COMMENT 'The CUSTOMERID defines the CustomerId of the SpendCapacity' NOT NULL ,
